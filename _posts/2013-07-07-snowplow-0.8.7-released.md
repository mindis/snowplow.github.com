...
As well as some tweaks and improvements, the bug fixes make the JavaScript Tracker work better with older versions of Internet Explorer. Many thanks to Snowplow client [BigCommerce] [bigcommerce] for bringing some of these issues to our attention.
