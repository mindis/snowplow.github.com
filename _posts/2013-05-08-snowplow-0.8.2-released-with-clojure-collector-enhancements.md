...
We're happy to announce the immediate release of Snowplow **0.8.2**. This release updates the Clojure Collector only; if you are using the CloudFront Collector, then no upgrade to 0.8.2 is necessary.
...
And that should be it. Thanks again to Mark for his contribution to this release - and we have some more exciting community contributions coming very soon to Snowplow, so watch this space!
