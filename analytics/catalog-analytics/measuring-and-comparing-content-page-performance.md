...
The recipes below all use the Snowplow page ping event to understand how a user engages with a particular web page over time. The recipes are divided into seven sections. In the first section, we introduce the page ping event: how to set it up and what data is captured with each event. In sections two and three, we use that data to visualize the behaviour of a single user, first as he / she navigates through your website, and secondly as he / she navigates through a web page.
...
<a href="/static/img/analytics/catalog-analytics/content-page-performance/average-pings-per-page.jpg"><img src="/static/img/analytics/catalog-analytics/content-page-performance/average-pings-per-page.jpg"></a>
...
<p style="text-align: center"><a href="/static/img/analytics/catalog-analytics/content-page-performance/filter-only-blog-pages.JPG"><img src="/static/img/analytics/catalog-analytics/content-page-performance/filter-only-blog-pages.JPG" width="250"></a></p>
...
<a href="/static/img/analytics/catalog-analytics/content-page-performance/average-pings-vs-doc-height.jpg"><img src="/static/img/analytics/catalog-analytics/content-page-performance/average-pings-vs-doc-height.jpg"></a>
...
<a href="/static/img/analytics/catalog-analytics/content-page-performance/content-page-matrix.jpg"><img src="/static/img/analytics/catalog-analytics/content-page-performance/content-page-matrix.jpg"></a>
