...
* We fixed a bug in the Hive deserializer where a partially-processed row was returned even a critical error was found in the row (a null row is now returned instead)
